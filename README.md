This repository contains the initial stages of a simple interpreter, currently in development. Its current functionality focuses on tokenizing the input, breaking it down into smaller meaningful units.
